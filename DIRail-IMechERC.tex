...
{
\usebackgroundtemplate{\transparent{0.2}\includegraphics[width= \paperwidth]{EmmaCastle}}
\frame{\titlepage}}
     ...
     \end{column}
     	\begin{column}[T]{8cm} 
         	\begin{center}
                    ...
                    draw = gray!50, 
                    fill =gray!20, opacity = 0.7, rounded corners, minimum height = 6.3cm, minimum width = 1.3cm},
                    modarr/.style={>=stealth, ->,line width = 3, draw = gray, opacity = 1},
                    workrect/.style={rectangle,align = center, 
                    draw = gray!70, 
                    fill =gray!70, opacity = 0.7, minimum width = 4.4cm, minimum height = 0.9cm, rounded corners},
                    otrect/.style={rectangle,align = center, 
                    draw = gray!70, 
                    fill = gray!70, opacity = 0.7, minimum width = 7.5cm, minimum height = 0.3cm, rounded corners},  
                    node distance = 1cm]
...
\frame{\frametitle{Struktur des Studiengangs - Vertiefungsstudium (Vollzeit)}
\framesubtitle{}
\begin{center}
\tikzset{font=\small}
\begin{tikzpicture}[
