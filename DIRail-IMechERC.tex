...
\begin{columns}[t] 
     ...
     \end{column}
     	\begin{column}[T]{7cm} 
         	\begin{center}
		\vspace{-.5cm}
            		\href{https://www.youtube.com/watch?v=_z9fII6lbig}{\includegraphics[width=0.9\textwidth]{Winners2019}} \source{Klicken f\"ur Video}\\
			Emma $\heartsuit$ J.I.M. \\
			IMechE Railway Challenge 2019\\ \vspace{.3cm}
			Grand Champion
        		\end{center}
     \end{column}
 \end{columns}
