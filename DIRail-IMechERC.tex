...
{
\usebackgroundtemplate{\includegraphics[width= \paperwidth]{EmmaCastle.jpg}}
...
\begin{columns}[t] 
     ...
     \end{column}
     	\begin{column}[T]{7cm} 
         	\begin{center}
		\vspace{-.5cm}
            		\href{https://www.youtube.com/watch?v=_z9fII6lbig}{\includegraphics[width=0.9\textwidth]{Winners2018}} \source{Klicken f\"ur Video}\\
			Emma $\heartsuit$ J.I.M. \\
			IMechE Railway Challenge 2018\\ \vspace{.3cm}
...
%		\end{itemize}
		...
		\item Warnwesten-Sponsor (2000 \euro) (verkauft)
     ...
     \end{column}
     	\begin{column}[T]{6cm} 
         	\begin{center}
            		\includegraphics[width=0.95\textwidth]{Team2019.jpg}\source{}
		Team Emma {\Large \color{mint!90!black}$\varheartsuit$} J.I.M. \\
		IMechE Railway Challenge 2019\\ \vspace{.5cm}
